...
fields_per_file = 20;       % number of field dumps to gather in each file
dump_period_distr = 2000;   % number of iterations between distribution dumps
dump_period_distr_1v = 1000;% number of iterations between f(z,vz) dumps
...
resistance = 0.0e0;      % series resistance in ohms for one square metre
                         % of fluxtube cross section at the left hand side
Nz=350;                  % number of grid points in space
...
vfromfile = 'yes';     % If 'yes', load initial vz from file. The global vz0
                       % will still be the reference for velocity shifting.
vz0 = 0.0e0;           % drift velocity
Tfromfile = 'yes';      % If 'yes', load T from file and ignore kTz and kTp.
...
Nvz=400;               % number of grid points in velocity
vzmin =   -1.0e6;      % minimum velocity - vz0
vzmax =    1.0e6;      % maximum velocity - vz0
vzshifting = 'on';
Nmu = 20;              % number of grid points in magnetic moment
mumin = 0;             % minimum magnetic moment
mumax = 2.5e-14;       % maximum magnetic moment
